...
const ModalFooterForwardRef = React.forwardRef((props: any, ref) => {
  ...
  return (
    ...
    >
      ...
      (footerContent.secondary || footerContent.primary) ? (
        <>
          <SecondaryAction {...footerContent.secondary}>
            {footerContent.secondary.text}
          </SecondaryAction>
          <PrimaryAction {...footerContent.primary}>
            {footerContent.primary.text}
          </PrimaryAction>
        </>
      ) : (
        [footerContent]
